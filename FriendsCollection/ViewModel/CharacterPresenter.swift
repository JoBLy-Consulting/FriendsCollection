...
//
//  Goal: This view is a View Model to present the characters cards in the list. The main character are on a red background with a star and the special guest are in a blue background with a "i" in a circle
